                     ...
                     <form action="delMember" method="post">
                        ...
                        <div class="form-label-group">
                           ...
                           <table style="width: 500px;">
                              <tr>
                                 <td><span>탈퇴 하시려면 비밀번호를 한번 더 입력하세요.</span></td>
                              </tr>
                              <tr>
                        ...
                        <input type="submit" style="width: 200px; background-color: #0c69ef" value="확인" class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2">                      
                     </form>                              
                  </div>
               </div>
            </div>
