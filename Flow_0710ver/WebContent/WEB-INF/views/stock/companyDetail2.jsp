				...
				<div class="head_tit">
					<h3>${cvo.c_name }
						...
						<c:choose>
							...
							<c:when test="${sessionScope.sessionID == null}">
								<img src="./resources/images/btn/heart1.svg" width="20px"
									class="likeImg" />
...
$(function() {
	$.ajax({
	    url:'http://192.168.0.7:8099/shop/make_chart?code=${cvo.c_code }',
	    type:'GET',
	    dataType:'jsonp',
		...
		$
				.ajax({
					...
					success : function(res) {
						...
						if (res != 1) {
							$('.likeImg').attr('src',
									"./resources/images/btn/heart2.svg");
						} else {
							$('.likeImg').attr('src',
									"./resources/images/btn/heart1.svg");
						}
						var likesNum = parseInt(res)
								+ parseInt($('#likes').html());
